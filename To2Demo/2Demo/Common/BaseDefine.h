...
#define DefaultTintColor                     RGBFromHex(0x508744)
#define DefaultBackGroundColor               RGBFromHex(0xF5F6F7)
#define DefaultPurpleColor                   RGBFromHex(0x6405ff)
#define DefaultGreenColor                    RGBFromHex(0x2c651f)
#define RegularFontName                       @"PingFangSC-Regular"
#define BoldFontName                          @"PingFangSC-Semibold"
